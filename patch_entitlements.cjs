...
code = code.replace('{/* 2. Module Configuration Section */}\n                <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "16px", padding: "24px", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}', entitlementUI);

fs.writeFileSync(path, code, 'utf8');
console.log('Added entitlements to Configurations');
